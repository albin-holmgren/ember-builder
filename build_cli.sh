...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/albin-holmgren/ember-versions/refs/heads/main"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/albin-holmgren/ember-binaries/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/albin-holmgren/ember-binaries/releases"
fi
